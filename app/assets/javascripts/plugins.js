$(document).ready(function(){
  ...
  if($("#wizard_ajax").length > 0){
    ...
    $("#wizard_ajax").validationEngine('attach',{
      promptPosition : "topLeft"
    });
    ...
    $('#wizard_ajax').stepy({
      ...
      next: function(index) {
        ...
        if((index-2) == 0){
          $.post('php/ajax_wizard.php',{
            login: $("#wizard_ajax input[name=login]").val(),
        ...
        if((index-2) == 1){
          $.post('php/ajax_wizard.php',{
            hash: $("#wizard_ajax input[name=hash]").val()
          },
          function(data){
            if(data == 'success')
              $('#wizard_ajax').stepy('step', index);
  ...
  if($("#progressbar_animated").length > 0){
    $("#progressbar_animated").progressbar({
      value: 0
    });
    $("#sAProgress").click(function(){
      ...
      $("#progressbar_animated").anim_progressbar({
        start: iNow,
        finish: iEnd,
        interval: 1
      });
  ...
  if($("#progressbar_delay").length > 0){
    ...
    $("#sWDProgress").click(function(){
      ...
      $("#progressbar_delay").anim_progressbar({
        start: iNow1,
        finish: iEnd1,
        interval: 1
      });
  ...
  //wysiwyg editor
  if($("#wysiwyg").length > 0){
    wEditor = $("#wysiwyg").cleditor({
      width:"100%",
      height:"300px"
    });
  }
  if($("#mail_wysiwyg").length > 0)
    m_editor = $("#mail_wysiwyg").cleditor({
      width:"100%",
      height:"100%",
